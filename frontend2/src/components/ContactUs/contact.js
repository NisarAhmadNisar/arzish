          ...
          <div className="containers">
            <div className="contactInfo">
              <div className="box">
                ...
                <div className="text">
                  <h3 className="header-tertiary-2">Address</h3>
                  <p className="paragraph-2">
                    um has been the industry's standard dummy text ever since
                    the 15
                  </p>
                </div>
              </div>
              <div className="box">
                ...
                <div className="text">
                  ...
                  <p className="paragraph-2">Arzish@ar.com</p>
                </div>
              </div>
              <div className="box">
                <div className="icon">
                ...
                <div className="text">
                  ...
                  <p className="paragraph-2">facebook.com/arzish</p>
                </div>
              </div>
              <div className="box">
                <div className="icon">
